...
import TeachersTabel from "./pages/Amin/TeachersTabel";
import StudentsTabel from "./pages/Amin/StudentsTabel";
import CoursesTabel from "./pages/Amin/CoursesTabel";
import VideosTabel from "./pages/Amin/VideosTabel";
import SpecializationsTabel from "./pages/Amin/SpecializationsTabel";
import CategoriesTabel from "./pages/Amin/CategoriesTabel";
import CommentsTabel from "./pages/Amin/CommentsTabel";
import QuestionsTabel from "./pages/Amin/QuestionsTabel";
import AnswersTabel from "./pages/Amin/AnswersTabel";
